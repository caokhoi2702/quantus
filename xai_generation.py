...
print('cuda name:', torch.cuda.get_device_name('cuda'), end='\n\n')
...
parser.set_defaults(method='agc')
parser.set_defaults(metrics='Faithfulness Correlation')
parser.set_defaults(save_npz=True)
